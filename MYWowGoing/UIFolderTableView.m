...
- (UIImage *)screenshotWithOffsetCard:(CGFloat)deltaY andsize:(CGSize)size
{
    NSLog(@"%@",NSStringFromCGSize(size));
    
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(320, 50), NO, 0.0);
