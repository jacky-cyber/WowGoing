...
- (id)initWithdelegate:(id<HZAreaPickerDelegate>)delegate andProvincesindex:(int)provincesIndex andCityIndex:(int)cityIndex
{
    ...
    if (self) {
        ...
        cities = [[provinces objectAtIndex:provincesIndex] objectForKey:@"cities"];
        
        self.locate.state = [[provinces objectAtIndex:provincesIndex] objectForKey:@"state"];
        ...
        [self.locatePicker selectRow:provincesIndex inComponent:0 animated:YES];
