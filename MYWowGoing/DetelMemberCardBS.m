...
@implementation DetelMemberCardBS
...
- (id)onExecute
{
    ...
    [jsonreq setValue:_customeridString forKey:@"customerid"];
    [jsonreq setValue:_membershipNumberString forKey:@"membershipNumber"];
    [jsonreq setValue:_memberInfoIdString forKey:@"memberInfoId"];
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/%@",SEVERURL,MEMBERSHIPCARD_DELETEMEMBER];
