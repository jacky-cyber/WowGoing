...
static const CGFloat CSToastCornerRadius        = 0.0;   //黑色背景是否是圆角
...
static const CGFloat CSToastActivityHeight      = 30.0;
static const NSString * CSToastActivityDefaultPosition = @"botton";
