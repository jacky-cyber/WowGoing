...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
		...
		UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, RefreshViewHight/3, self.frame.size.width, 20.0f)];
		...
		label = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, RefreshViewHight /5.0f, self.frame.size.width, 20.0f)];
		label.autoresizingMask = UIViewAutoresizingFlexibleWidth;
		...
		view.frame = CGRectMake(90.0f, RefreshViewHight / 5.0f, 20.0f, 20.0f);
...
- (void)setState:(EGOPullRefreshState)aState{
	...
	switch (aState) {
		case EGOOPullRefreshPulling:
			...
			_statusLabel.text = NSLocalizedString(@"松开后加载更多...", @"松开后加载更多...");
			[CATransaction begin];
		...
		case EGOOPullRefreshNormal:
            ...
            //            UIFont *font = [UIFont fontWithName:@"DFPShaoNvW5-GB" size:15];
		...
		case EGOOPullRefreshLoading:
			...
			_statusLabel.text = NSLocalizedString(@"正在载入更多...", @"正在载入更多...");
